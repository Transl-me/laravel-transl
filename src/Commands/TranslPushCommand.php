...
class TranslPushCommand extends Command
{
    use UsesConfig;
    use UsesProject;
    use UsesBranch;
    ...
    protected $signature = '
        ...
        {--message=            : Will push and save the translation lines with the given message}
     ...
     * @var string
     */
    protected $description = "Pushes the defined project's translation lines to Transl.me";
